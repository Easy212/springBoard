...
<body>
	...
	>
		<table align="center" width="500">
			<tr>
				<td>제목:</td>
				<td><input type="text" name="title" data-label="제목"
					oninput="removeWhiteSpaces(this)" onpaste="handlePasteEvent(this)" /></td>
			</tr>
			<tr>
				<td>이름:</td>
				<td><input type="text" name="name" data-label="이름"
					oninput="removeWhiteSpaces(this)" onpaste="handlePasteEvent(this)" /></td>
			</tr>
			
			<tr>
				<td>내용:</td>
				<td><textarea name="content" data-label="내용" rows="5" cols="50"
						oninput="removeWhiteSpaces(this)" onpaste="handlePasteEvent(this)"></textarea></td>
			</tr>
			<tr>
				<td>비밀번호:</td>
				<td><input type="password" name="pass" data-label="비밀번호"/></td>
			</tr>
			<tr>
				<td>파일첨부:</td>
