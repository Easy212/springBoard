...
public class BoardDaoImpl extends SqlSessionDaoSupport implements BoardDao {
	...
	@Override
	public void updateOrderNo(BoardVO board) {
	    getSqlSession().update("updateOrderNo", board);
	}
	...
	public void updateOrderNoForReply(BoardVO boardVO) throws Exception {
	    ...
	    paramMap.put("parent_order_no", boardVO.getOrder_no());
	    getSqlSession().update("updateOrderNoForReply", paramMap);
	}

	@Override
	public BoardVO getNextBoard(int groupId, int depth, int orderNo) {
	    Map<String, Object> paramMap = new HashMap<>();
	    paramMap.put("group_id", groupId);
	    paramMap.put("depth", depth);
	    paramMap.put("order_no", orderNo); 
	    return getSqlSession().selectOne("getNextBoard", paramMap);
	}
	
	@Override
    public List<BoardVO> getBoardsGreaterThanOrderNo(int group_id, int order_no) {
        Map<String, Object> paramMap = new HashMap<>();
        paramMap.put("group_id", group_id);
        paramMap.put("order_no", order_no);
        return getSqlSession().selectList("getBoardsGreaterThanOrderNo", paramMap);
    }
}
