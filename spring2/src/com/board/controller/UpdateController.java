        ...
        try {
            ...
            if (fileDeleted != null && fileDeleted.equalsIgnoreCase("true")) {
                if (existingBoard.getUploadedFile() != null) {
                    Path deletePath = Paths.get(projectRealPath + uploadDirPath + File.separator + existingBoard.getUploadedFile());
                ...
                if (file != null && !file.isEmpty()) {
                    ...
                    Path uploadPath = Paths.get(projectRealPath + uploadDirPath + File.separator + newFileName);
